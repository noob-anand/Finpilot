...
type CreateInvestmentFormProps = {
  onInvestmentCreate: (investment: Omit<Investment, 'id'>) => void;
};

export function CreateInvestmentForm({ onInvestmentCreate }: CreateInvestmentFormProps) {
